...
urlpatterns = [
    ...
    url(r'^appraisal/$',views.AppraisalView.as_view(),name='appraisal'),
    # url(r'^appraisal/(?P<vin_num>[\w]+)$',views.AppraisalDetailView.as_view(),name='appraisal_detail'),
    url(r'^appraisal/detail/$',views.AppraisalDetailView.as_view(),name='appraisal_detail'),
